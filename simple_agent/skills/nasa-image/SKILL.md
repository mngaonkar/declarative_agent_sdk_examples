...
Download the image using curl command and save it in current folder named workspce. If folder is not present then create the folder in current directory. Also save the title, explanation and image name in a text file. Save all the files in workspace directory.